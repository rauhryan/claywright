...
const fixture = new URL("./fixtures/click-counter-async.tsx", import.meta.url).pathname;

describe("click counter blackbox async", () => {
  ...
  test("clicking box increments counter after microtask", async () => {

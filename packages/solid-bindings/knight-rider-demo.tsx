    ...
    <box width={grow()} height={grow()} direction="ttb" bg={BG_INT}>
        ...
        <box width={fixed(barTotalW)} height={fixed(CELL_H)} direction="ltr" gap={1}>
          {cells.map((i) => (
            <box
              ...
              width={fixed(CELL_W)}
              height={fixed(CELL_H)}
              bg={squareColor(i, frame(), isRunning)}
            >
              <text> </text>
            </box>
          ))}
      ...
      <box width={grow()} height={fixed(3)} direction="ltr" alignX={4} gap={3}>
        <box
          ...
          width={fixed(8)}
          height={fixed(3)}
          bg={isRunning ? rgba(40, 120, 70) : BTN_HOVER}
          border={{
            color: isRunning ? rgba(80, 180, 120) : rgba(90, 140, 255),
            left: 1,
            right: 1,
            top: 1,
            bottom: 1,
        ...
        >
          <box width={grow()} height={grow()} alignX={4} alignY={4}>
        ...
        <box
          ...
          width={fixed(8)}
          height={fixed(3)}
          bg={isRunning ? BTN_HOVER : BTN_IDLE}
          border={{
            color: isRunning ? rgba(200, 80, 80) : rgba(90, 90, 110),
            left: 1,
            right: 1,
            top: 1,
            bottom: 1,
